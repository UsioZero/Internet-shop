...
//Database start
PhoneAccessory headphones1 = PhoneAccessory(1, 'headphone', 'Razer Kraken',
...
PhoneAccessory headphones2 = PhoneAccessory(2, 'headphone', 'Xiaomi Mi Air 2',
...
PhoneAccessory headphones3 = PhoneAccessory(3, 'headphone', 'Kingston HyperX',
...
PhoneAccessory charger1 = PhoneAccessory(4, 'charger', 'Xiaomi Mi Qi Car',
...
PhoneAccessory charger2 = PhoneAccessory(5, 'charger', 'Xiaomi Mi Car ',
...
PhoneAccessory screen1 = PhoneAccessory(6, 'screen', 'Hiprotec Gel',
...
PhoneAccessory screen2 = PhoneAccessory(7, 'screen', 'TemperedCurve',
...
PC monitor1 = PC(8, 'monitor', 'Philips 223V5LHSB2/00',
...
PC monitor2 = PC(9, 'monitor', 'HP Curved (Z4N74AA) Refurbished',
...
PC keyboard1 = PC(
    10,
    'keyboard',
    'Logitech G915 Lightspeed Wireless RGB GL Tactile (920-008909)',
...
PC keyboard2 = PC(11, 'keyboard', 'FrimeCom FC-838-USB Black/Orange',
...
PC mouse1 = PC(12, 'mouse', 'Frime Hela Black USB (FMC1840)',
  ...
  while (true) {
    ...
    switch (readerType) {
      case 'для пк':
        ...
        while (true) {
          var readerPodType = stdin.readLineSync();
          switch (readerPodType) {
            case 'монитор':
              print('   Первый представитель:');
              monitor1.writeDiscription();
